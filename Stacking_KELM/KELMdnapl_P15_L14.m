function TY=KELMdnapl_P15_L14(XX)
%y标准化了精度高，用这个
% figure(1);
% plot(d,'o-');
% % grid on;
...
f=f';
%%
kernel_pars(1:2)=[1.02501842454131,1.85512786671900];
%train
...
[TrainingTime, TestingTime, TrainingAccuracy, TestingAccuracy,TY] = elm_kernel('sinc_train', 'sinc_test', 0, 9.99964863060858, 'poly_kernel',kernel_pars);
TY=TY';
% fid = fopen('TY1','w');
% fprintf(fid,'%2.8f\n',TY);
% TY2=load('TY1')
