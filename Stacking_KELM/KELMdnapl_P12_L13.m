function TY=KELMdnapl_P12_L13(XX)
%y标准化了精度高，用这个
% figure(1);
% plot(d,'o-');
% % grid on;
...
Y(1:100,1) = M(1:100,12);
Y(101:150,1) = M(151:200,12);
...
f=f';
%%
kernel_pars(1:2)=[329.121226940192,2.57401176017558];
%train
...
[TrainingTime, TestingTime, TrainingAccuracy, TestingAccuracy,TY] = elm_kernel('sinc_train', 'sinc_test', 0, 366.827483976706, 'poly_kernel',kernel_pars);
TY=TY';
% fid = fopen('TY1','w');
% fprintf(fid,'%2.8f\n',TY);
% TY2=load('TY1')
