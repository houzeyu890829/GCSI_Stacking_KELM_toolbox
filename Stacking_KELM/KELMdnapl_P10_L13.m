function TY=KELMdnapl_P10_L13(XX)
%y标准化了精度高，用这个
% figure(1);
% plot(d,'o-');
% % grid on;
...
X(1:100,1:32)= M(1:100,17:48);
X(101:150,1:32)= M(151:200,17:48);
% X(31:90,1:8)= M(61:120,1:8);
Y(1:100,1) = M(1:100,10);
Y(101:150,1) = M(151:200,10);
...
f=f';
%%
kernel_pars(1:2)=[194.511687592020,2.33474380775523];
%train
...
[TrainingTime, TestingTime, TrainingAccuracy, TestingAccuracy,TY] = elm_kernel('sinc_train', 'sinc_test', 0, 782.971316068510, 'poly_kernel',kernel_pars);
TY=TY';
% fid = fopen('TY1','w');
% fprintf(fid,'%2.8f\n',TY);
% TY2=load('TY1')
