function TY=KELMdnapl_P10_L14(XX)
%y标准化了精度高，用这个
% figure(1);
% plot(d,'o-');
% % grid on;
...
X(1:150,1:32)= M(1:150,17:48);
% X(31:90,1:8)= M(61:120,1:8);
Y(1:150,1) = M(1:150,10);
...
f=f';
%%
kernel_pars(1:2)=[0.894682136019532,0.302269169755851];
%train
...
[TrainingTime, TestingTime, TrainingAccuracy, TestingAccuracy,TY] = elm_kernel('sinc_train', 'sinc_test', 0, 9.19788566821473, 'poly_kernel',kernel_pars);
TY=TY';
% fid = fopen('TY1','w');
% fprintf(fid,'%2.8f\n',TY);
% TY2=load('TY1')
