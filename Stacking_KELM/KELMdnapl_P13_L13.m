function TY=KELMdnapl_P13_L13(XX)
%y标准化了精度高，用这个
% figure(1);
% plot(d,'o-');
% % grid on;
...
Y(1:100,1) = M(1:100,13);
Y(101:150,1) = M(151:200,13);
...
f=f';
%%
kernel_pars(1:2)=[490.910976854294,2.65735395721656];
%train
...
[TrainingTime, TestingTime, TrainingAccuracy, TestingAccuracy,TY] = elm_kernel('sinc_train', 'sinc_test', 0, 181.715061715694, 'poly_kernel',kernel_pars);
TY=TY';
% fid = fopen('TY1','w');
% fprintf(fid,'%2.8f\n',TY);
% TY2=load('TY1')
