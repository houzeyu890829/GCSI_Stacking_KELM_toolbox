...
[Y(1,1:n_identification),fit_gen1_PSO,avgfitness_gen1_BSO,v_r1]=P_BSO_EL_L(Initial_S,Initial_output,150,ob,0.1);


[Y(2,1:n_identification),fit_gen2_PSO,avgfitness_gen2_BSO,v_r2]=P_BSO_EL_L(Y(1,1:n_identification),Initial_output,150,ob,0.234923789);


[Y(3,1:n_identification),fit_gen3_PSO,avgfitness_gen3_BSO,v_r3]=P_BSO_EL_L(Y(2,1:n_identification),Initial_output,150,ob,0.381677891);


[Y(4,1:n_identification),fit_gen4_PSO,avgfitness_gen4_BSO,v_r4]=P_BSO_EL_L(Y(3,1:n_identification),Initial_output,150,ob,0.526552882);


[Y(5,1:n_identification),fit_gen5_PSO,avgfitness_gen5_BSO,v_r5]=P_BSO_EL_L(Y(4,1:n_identification),Initial_output,150,ob,0.659753955);


[Y(6,1:n_identification),fit_gen6_PSO,avgfitness_gen6_BSO,v_r6]=P_BSO_EL_L(Y(5,1:n_identification),Initial_output,150,ob,0.774596669);


[Y(7,1:n_identification),fit_gen7_PSO,avgfitness_gen7_BSO,v_r7]=P_BSO_EL_L(Y(6,1:n_identification),Initial_output,150,ob,0.867040164);


[Y(8,1:n_identification),fit_gen8_PSO,avgfitness_gen8_BSO,v_r8]=P_BSO_EL_L(Y(7,1:n_identification),Initial_output,150,ob,0.935248448);


[Y(9,1:n_identification),fit_gen9_PSO,avgfitness_gen9_BSO,v_r9]=P_BSO_EL_L(Y(8,1:n_identification),Initial_output,150,ob,0.979148362);


[Y(10,1:n_identification),fit_gen10_PSO,avgfitness_gen10_BSO,SR,MC,v_r10,v_r_all10]=P_BSO_EL_F(Y(9,1:n_identification),Initial_output,150,ob,1);
save('Feed_H_PBSO_4');
